...
<div class="container">
  ...
  <form name="form1" method="post" action="" class="form-horizontal" role="form">
    ...
    <button type="button" class="btn btn-info"  onclick="window.location='index.php?page=update_cusinfor'">Update</button>
    <button type="button" class="btn btn-primary" onclick="window.location='index.php?page=passinfor'">Change Password</button>
