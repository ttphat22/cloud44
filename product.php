...
<form name="frm" method="post">
    ...
    <p>
        <a class="glyphicon glyphicon-plus" href="index.php?page=add_product"> Add</a>
    </p>
    <table id="tableproduct" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td align='center'><a class="glyphicon glyphicon-edit" href="index.php?page=update_product&&id=<?php echo $row["pro_id"]; ?>"></a></td>
            <td align="center"><a class="glyphicon glyphicon-trash" href="index.php?page=product&&function=del&&id=<?php echo $row["pro_id"]; ?>" onclick="return deleteConfirm()"></a></td>
        </tr>
        <?php
            $No++;
            }
