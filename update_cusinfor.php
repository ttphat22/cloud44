		...
		if($err!="")
    {
      ...
      include_once("connection.php");
			...
			if(pg_num_rows($result)==1)
			{
				...
				echo '<meta http-equiv="refresh" content="0;URL=index.php?page=cusinfor"/>';
      }
		}
  }
...
<div class="container">
  ...
  <form name="form1" method="post" class="form-horizontal" role="form">
    ...
    <button type="button" class="btn btn-danger" name="btnCancel" onclick="window.location='index.php?page=cusinfor'">Cancel</button>
